...
import {  getImgNaturalDimensions, corresponed, corresFuns,getLocalItem } from '@/utils/commonFuns'
...
export default {
  ...
  methods:{
    getList(){
      const param = {username: this.username}
     getControlCount(param).then(res=>{
